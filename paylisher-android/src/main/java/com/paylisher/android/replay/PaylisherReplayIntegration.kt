...
import com.paylisher.android.internal.densityValue
import com.paylisher.android.internal.displayMetrics
import com.paylisher.android.internal.screenSize
import com.paylisher.android.replay.internal.NextDrawListener.Companion.onNextDraw
import com.paylisher.android.replay.internal.ViewTreeSnapshotStatus
import com.paylisher.android.replay.internal.isAliveAndAttachedToWindow
import com.paylisher.internal.PaylisherThreadFactory
import com.paylisher.internal.replay.RRCustomEvent
import com.paylisher.internal.replay.RREvent
import com.paylisher.internal.replay.RRFullSnapshotEvent
import com.paylisher.internal.replay.RRIncrementalMouseInteractionData
import com.paylisher.internal.replay.RRIncrementalMouseInteractionEvent
import com.paylisher.internal.replay.RRIncrementalMutationData
import com.paylisher.internal.replay.RRIncrementalSnapshotEvent
import com.paylisher.internal.replay.RRMetaEvent
import com.paylisher.internal.replay.RRMouseInteraction
import com.paylisher.internal.replay.RRMutatedNode
import com.paylisher.internal.replay.RRRemovedNode
import com.paylisher.internal.replay.RRStyle
...
public class PaylisherReplayIntegration(
    ...
    private val executor by lazy {
        Executors.newSingleThreadScheduledExecutor(PaylisherThreadFactory("PaylisherReplayThread"))
    }
    ...
    private fun View.toScreenshotWireframe(window: Window): RRWireframe? {
        ...
        val thread = HandlerThread("PaylisherReplayScreenshot")
        thread.start()
