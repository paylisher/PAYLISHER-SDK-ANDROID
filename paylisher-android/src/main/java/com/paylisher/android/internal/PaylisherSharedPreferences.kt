...
import com.paylisher.internal.PaylisherPreferences.Companion.STRINGIFIED_KEYS

/**
 * Reads and writes to the SDKs shared preferences
 * The shared pref is called "paylisher-android-$apiKey"
 ...
 */
internal class PaylisherSharedPreferences(
    private val context: Context,
    private val config: PaylisherAndroidConfig,
    private val sharedPreferences: SharedPreferences = context.getSharedPreferences("paylisher-android-${config.apiKey}", MODE_PRIVATE),
) :
    PaylisherPreferences {
