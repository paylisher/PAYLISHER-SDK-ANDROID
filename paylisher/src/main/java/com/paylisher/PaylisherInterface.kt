...
/**
 * The Paylisher SDK entry point
 */
public interface PaylisherInterface {
    /**
     * Setup the SDK
     * @param config the SDK configuration
     */
    public fun <T : PaylisherConfig> setup(config: T)
     ...
     * @param userProperties the user properties, set as a "$set" property, Docs https://paylisher.com/docs/product-analytics/user-properties
     * @param userPropertiesSetOnce the user properties to set only once, set as a "$set_once" property, Docs https://paylisher.com/docs/product-analytics/user-properties
     * @param groups the groups, set as a "$groups" property, Docs https://paylisher.com/docs/product-analytics/group-analytics
     */
    public fun capture(
        event: String,
    ...
    /**
     * Identifies the user
     * Docs https://paylisher.com/docs/product-analytics/identify
     ...
     */
    public fun reloadFeatureFlags(onFeatureFlags: PaylisherOnFeatureFlags? = null)
    ...
    /**
     * Creates a group
     * Docs https://paylisher.com/docs/product-analytics/group-analytics
     * @param type the Group type
     * @param key the Group key
     * @param groupProperties the Group properties, set as a "$group_set" property, Docs https://paylisher.com/docs/product-analytics/group-analytics
     */
    public fun group(
        type: String,
        key: String,
     ...
     * Docs https://paylisher.com/docs/product-analytics/identify#alias-assigning-multiple-distinct-ids-to-the-same-user
     ...
     * PaylisherPreferences.ALL_INTERNAL_KEYS are not allowed since they are internal and used by
     * the SDK only.
     * @param key the Key
    ...
    @PaylisherInternal
    public fun <T : PaylisherConfig> getConfig(): T?
}
